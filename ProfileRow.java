...
public class ProfileRow extends UserSectionRow {
    private JTextArea textArea;

    public ProfileRow(String text) {
        super(text);
        ...
        textArea.setRows(3); // Show up to 3 rows for profile statements (more than skills)
        ...
        // Set size constraints - make it taller to accommodate wrapped text
